        ...
        <ul class="nav nav-pills flex-column mb-auto mt-2">
          <li>
            <a href="#submenu1" data-bs-toggle="collapse" class="nav-link active text-white" aria-current="page">
              <i class="fs-4 bi-box-seam me-2"></i> <span class="d-none d-sm-inline">Produk</span>
            </a>
          ...
          <li>
            <a href="admin-pesanan" class="nav-link text-white"> <i class="fs-4 bi-table me-2"></i> <span class="d-none d-sm-inline">Grafik</span> </a>
          </li>
        </ul>
      </div>
      <!-- TABEL -->
      <div class="container mb-3">
        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            $options = array(
                CURLOPT_URL => 'https://asia-south1.gcp.data.mongodb-api.com/app/application-0-aeujc/endpoint/getAllSayur',
            ...
            foreach ($data as $row) :
              ...
              <a href="'.route('delete-sayur', ['id' => $row->_id]).'" class="btn btn-danger mt-1 delete-btn btn-sm" onclick="return confirm(\'Apakah anda yakin akan menghapus data?\');">Hapus</a>
              </td>
        ...
        <!-- =========== MODAL FORM TAMBAH SAYUR =========== -->

        <div class="modal fade" id="modalSayurTambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
              <div class="modal-content">
                  <div class="modal-header">
                      <h1 class="modal-title fs-5" id="exampleModalLabel">Form Tambah Sayur</h1>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body">
                      <form id="formSayurTambah" action="/simpan-sayur" method="post">
                          @csrf
                          <div class="mb-3">
                          ...
                          <div class="mb-3">
                              <label for="harga" class="form-label">Harga Sayur</label>
                              <input type="number" class="form-control" id="harga" name="harga"
                                  placeholder="harga" required>
                          </div>
                          <div class="mb-3">
                            <label for="kategori" class="form-label">kategori Sayur</label>
                            <input type="text" class="form-control" id="kategori" name="kategori"
                                placeholder="kategori" required>
                          </div>
                          <div class="mb-3">
                            <label for="berat" class="form-label">berat Sayur</label>
                            <input type="text" class="form-control" id="berat" name="berat"
                                placeholder="berat" required>
                          </div>
                          <div class="mb-3">
                            <label for="gizi" class="form-label">gizi Sayur</label>
                            <input type="text" class="form-control" id="gizi" name="gizi"
                                placeholder="gizi" required>
                          </div>
                          <div class="mb-3">
                            <label for="cara_menyimpan" class="form-label">cara menyimpan Sayur</label>
                      ...
                      <div class="modal-footer">
                          ...
                          <button id="save" type="submit" class="btn btn-success" form="formSayurTambah">Simpan</button>
                      </div>
                  </div>
              </div>
          </div>
        ...
        <div class="modal fade" id="modalSayurEdit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
              <div class="modal-content">
                  <div class="modal-header">
                      <h1 class="modal-title fs-5" id="exampleModalLabel">Form Edit Sayur</h1>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body">
                      <form id="formSayurEdit" action="/update-sayur" method="post">
                          @csrf
                          <div class="mb-3">
                              <label for="nama" class="form-label">Nama Sayur</label>
                      ...
                      <div class="modal-footer">
                          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                          <button id="save" type="submit" class="btn btn-success" form="formSayurEdit">Simpan</button>
                      </div>
                  </div>
              </div>
          </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.edit').click(function(){
                ...
                $.ajax({
                    url: 'https://asia-south1.gcp.data.mongodb-api.com/app/application-0-aeujc/endpoint/getSayurById?id=' + id,
                    type: 'GET',
                    success: function(res){
                        var data = res[0];
                        $('#modalSayurEdit').modal('show');
