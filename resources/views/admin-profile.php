        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse centered-navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex me-lg-0 my-4 my-lg-0">
				...
				<a href="/admin-profile"><span><i class="fa-solid fa-user" style="margin-right: 5px;"></i></span></a>
            </form>
          </div>
...
?>
            ...
            <a href="/admin"><div class="d-flex flex-row justify-content-between align-items-center p-3 mx-3">
                <div class="d-flex flex-row align-items-center"><i class="fas fa-calendar-o"></i>
                    <div class="d-flex flex-row align-items-start ml-3" style="color: black;" ><span>Tabel Admin</span></div>
                </div>
             ...
             <!-- <a href="services.php"><div class="d-flex flex-row justify-content-between align-items-center p-3 mx-3">
    ...
    <div class="modal fade" id="modalAkun" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                <form id="formAkun" action="/editprofile">
                <div class="mb-3">
