  ...
  <body>
    ...
    <div style="margin-top: 110px;">
        <ul class="nav kategori-menu justify-content-center">
            <li class="nav-item">
                <a href="sayur.php" class="btn btn-outline w-100 sayur" style="margin-left: 10px;border-color: #4E7302;"onmouseover="this.style.color='#ffffff'; this.style.backgroundColor='#4E7302';"
                onmouseout="this.style.color='#000000'; this.style.backgroundColor='transparent';">Sayur</a>
            </li>
            <li class="nav-item">
                <a href="buah.php" class="btn btn-outline w-100 buah" style="margin-left: 15px; background-color: #4E7302;color: white;">Buah</a>
            </li>
        </ul>
    </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-lg-3 col-6 mt-3">
                    <div class="card clickable-card">
                        ...
                        <div class="text-right buttons">
                            <a href="strawberry.php" class="btn btn-details"><i class="fas fa-info-circle"></i> Detail</a>
                ...
                <div class="col-lg-3 col-6 mt-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                        <div class="text-right buttons">
                            <a href="melon-greeniegal.php" class="btn btn-details"><i class="fas fa-info-circle"></i> Detail</a>
                            <button class="btn btn-cart"><i class="fas fa-cart-plus"></i> Add to Cart</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-6 mt-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                        <div class="text-right buttons">
                            <a href="tomat-cherry.php" class="btn btn-details"><i class="fas fa-info-circle"></i> Detail</a>
                            <button class="btn btn-cart"><i class="fas fa-cart-plus"></i> Add to Cart</button>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="col-lg-3 col-6 mt-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                        <div class="text-right buttons">
                            <a href="strawberry-celeb.php" class="btn btn-details"><i class="fas fa-info-circle"></i> Detail</a>
                            <button class="btn btn-cart"><i class="fas fa-cart-plus"></i> Add to Cart</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-6 mt-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                        <div class="text-right buttons">
                            <a href="blackberry.php" class="btn btn-details"><i class="fas fa-info-circle"></i> Detail</a>
                            <button class="btn btn-cart"><i class="fas fa-cart-plus"></i> Add to Cart</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-6 mt-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                        <div class="text-right buttons">
                            <a href="semangka-merah.php" class="btn btn-details"><i class="fas fa-info-circle"></i> Detail</a>
                            <button class="btn btn-cart"><i class="fas fa-cart-plus"></i> Add to Cart</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-6 mt-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                        <div class="text-right buttons">
                            <a href="timun.php" class="btn btn-details"><i class="fas fa-info-circle"></i> Detail</a>
                            <button class="btn btn-cart"><i class="fas fa-cart-plus"></i> Add to Cart</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-6 mt-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                        <div class="text-right buttons">
                            <a href="anggur-merah.php" class="btn btn-details"><i class="fas fa-info-circle"></i> Detail</a>
                            <button class="btn btn-cart"><i class="fas fa-cart-plus"></i> Add to Cart</button>
                        </div>
                    </div>
                </div>
