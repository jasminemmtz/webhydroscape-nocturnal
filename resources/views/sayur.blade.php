...
<html lang="en">
  ...
  <body>
    ...
    <ul class="nav kategori-menu d-flex justify-content-center">
        ...
        <li class="nav-item">
            <a href="/buah" class="btn btn-outline w-100 buah" style="margin-left: 15px; border-color: #4E7302;" onmouseover="this.style.color='#ffffff'; this.style.backgroundColor='#4E7302';"
    ...
    <div class="products">
        <div class="row g-3">
                ...
                <div class="card clickable-card">
                    ...
                    <div class="card-body">
                        <div class="text-right buttons">
                            <a href="/bayam-hijau" class="btn btn-details"><i class="fas fa-info-circle"></i> Detail</a>
            ...
            <div class="col-lg-3 col-6 mt-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="text-right buttons">
                            <a href="/kangkung" class="btn btn-details"><i class="fas fa-info-circle"></i> Detail</a>
                            <button class="btn btn-cart"><i class="fas fa-cart-plus"></i> Add to Cart</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-6 mt-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="text-right buttons"> 
                            <a href="/daun-kemangi" class="btn btn-details"><i class="fas fa-info-circle"></i> Detail</a>
                            <button class="btn btn-cart"><i class="fas fa-cart-plus"></i> Add to Cart</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-6 mt-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="text-right buttons"> 
                            <a href="/curly-kale" class="btn btn-details"><i class="fas fa-info-circle"></i> Detail</a>
                            <button class="btn btn-cart"><i class="fas fa-cart-plus"></i> Add to Cart</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-6 mt-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-body">
                            <div class="text-right buttons"> 
                                <a href="/mizuna" class="btn btn-details"><i class="fas fa-info-circle"></i> Detail</a> 
                                <button class="btn btn-cart"><i class="fas fa-cart-plus"></i> Add to Cart</button> 
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-6 mt-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-body">
                            <div class="text-right buttons"> 
                                <a href="/caisim" class="btn btn-details"><i class="fas fa-info-circle"></i> Detail</a> 
                                <button class="btn btn-cart"><i class="fas fa-cart-plus"></i> Add to Cart</button> 
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-6 mt-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-body">
                            <div class="text-right buttons"> 
                                <a href="/baby-pakchoy" class="btn btn-details"><i class="fas fa-info-circle"></i> Detail</a> 
                                <button class="btn btn-cart"><i class="fas fa-cart-plus"></i> Add to Cart</button> 
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-3 col-6 mt-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="text-right buttons"> 
                            <a href="/selada-keriting" class="btn btn-details"><i class="fas fa-info-circle"></i> Detail</a>
                            <button class="btn btn-cart"><i class="fas fa-cart-plus"></i> Add to Cart</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-6 mt-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="text-right buttons"> 
                            <a href="/selada-romaine" class="btn btn-details"><i class="fas fa-info-circle"></i> Detail</a>
                            <button class="btn btn-cart"><i class="fas fa-cart-plus"></i> Add to Cart</button>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-3 col-6 mt-3">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="text-right buttons">
                        <a href="/daun-ketumbar" class="btn btn-details"><i class="fas fa-info-circle"></i> Detail</a>
                        <button class="btn btn-cart"><i class="fas fa-cart-plus"></i> Add to Cart</button>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-3 col-6 mt-3">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="text-right buttons">
                        <a href="/kembang-kol" class="btn btn-details"><i class="fas fa-info-circle"></i> Detail</a>
                        <button class="btn btn-cart"><i class="fas fa-cart-plus"></i> Add to Cart</button>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-3 col-6 mt-3">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="text-right buttons"> 
                        <a href="/cabai-merah" class="btn btn-details"><i class="fas fa-info-circle"></i> Detail</a>
                        <button class="btn btn-cart"><i class="fas fa-cart-plus"></i> Add to Cart</button>
                    </div>
                </div>
            </div>
